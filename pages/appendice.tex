...
\xjtuspchapter{附录A~公式定理证明}{\vspace{-4mm}附录A\quad 公式定理证明}{Appendix A Proofs of Equations and Theoremsices}
...
\xjtuspchapter{附录B~算法与代码}{\vspace{-4mm}附录B\quad 算法与代码}{Appendix B Algorithms and Codes}
